 ...
 */
export async function createMiniServer({ store, config, token, bindAddresses, tunnelHost, onInstruction, onStop, onUnqueue, onUpload, onSessionOpened, log, tree, browse, build }) {
